...
if __name__ == '__main__':
    commands = ["PYTHONPATH=. python train-bert-approach.py  --train_path /scratch/gpfs/altosaar/dat/longform-data/BERT/mapped-data/train.json --test_path /scratch/gpfs/altosaar/dat/longform-data/BERT/mapped-data/test.json --eval_path /scratch/gpfs/altosaar/dat/longform-data/BERT/mapped-data/evaluation.json "]
    ...
    base_grid.dict_dir = pathlib.Path("/scratch/gpfs/altosaar/dat/longform-data/BERT/dictionaries")
