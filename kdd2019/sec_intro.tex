...
% In addition to many attributes, there are an even larger number of items.
...
% theoretically-justified, but are not tied to the evaluation metrics used to
